# Plot comparing variation in learning curves by removing  Both experience replay and target network.
...
np.save('saves/avg_100_steps_wo_both', avg_100_steps)
np.save('saves/step_counts_wo_both', step_counts)
np.save('saves/results_wo_both', results)
