# Plot comparing variation in learning curves by removing Experience replay memory 
import gym
import random
...
np.save('saves/avg_100_steps_wo_replay', avg_100_steps)
np.save('saves/step_counts_wo_replay', step_counts)
np.save('saves/results_wo_replay', results)
